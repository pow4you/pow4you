...
<ul>
  <li>
    🔭 <strong>Background:</strong> Embedded software for two ESA-partnered projects:
    NASA Psyche/DSOC ground station software and QKDSat, developed with Honeywell UK,
    Redwire, and British Telecom under ECSS space product assurance standards.
  </li>

  <li>
    🌱 <strong>Quantum computing:</strong> Qiskit and QASM.
  </li>

  <li>
    💬 <strong>Ask me about:</strong> Quantum communications, embedded systems,
    Vue/Nuxt, and PostgreSQL.
  </li>

  <li>
    📫 <strong>Portfolio:</strong>
    <a href="https://pow.gay">pow.gay</a>
  </li>
</ul>
